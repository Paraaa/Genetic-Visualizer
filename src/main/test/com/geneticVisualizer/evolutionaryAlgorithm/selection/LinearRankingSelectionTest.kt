...
internal class LinearRankingSelectionTest {

    var initializer = QuadrantInitial(-465.0,465.5,-335.0,335.0)
    var population= initializer.initialize(VectorGenome(), 500)

    var linearRankingSelection: LinearRankingSelection = LinearRankingSelection(1.8)

    @Test
    fun selection() {population = initializer.initialize(VectorGenome(), 500)
        population.forEach { genome ->
            genome.calcFitness(1, Sphere())
        }
        var selectedPopulation1 = linearRankingSelection.selection(population,600)
        ...
        var selectedPopulation2 = linearRankingSelection.selection(population,500)
        ...
        var selectedPopulation3 = linearRankingSelection.selection(population,261)
        ...
        var selectedPopulation4 = linearRankingSelection.selection(population,0)
        ...
        var selectedPopulation5 = linearRankingSelection.selection(population,1)
